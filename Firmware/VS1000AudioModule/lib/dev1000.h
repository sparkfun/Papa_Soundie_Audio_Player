...
#define PATCH_TEST_UNIT_READY /* PatchMSCPacketFromPC() calls
                               * ScsiTestUnitReady() */
 ...
 */
auto void SpiSendBlockMmc (register __i0 u_int16 * data,
 ...
 */
void LowClock (register __a1 u_int16 wakeupIoKeys,
               register __reg_c u_int32 wakeupTime);
...
*/
void FIFOInit (register __i2 struct FIFOX *f, register __a1 void *fifoBuf,
...
/** 20110517: 135 words, stack usage about 44 words.
    ...
    other values (currently -1) for uncorrectable errors.
 */
s_int16 Large8kPageReadForCopyBack (u_int32 page, u_int16 * data,
                                    u_int16 * meta);
...
u_int16 SpiReadDataDiscardOne (register __i2 u_int16 * data,
                               register __a1 s_int16 words);
...
/** 20110816:
    ...
    other values (currently -1) for uncorrectable errors.
 */
s_int16 Large4kPageReadForCopyBack (u_int32 page, u_int16 * data,
                                    u_int16 * meta);
/** 20120816:
...
enum CodecError PatchCodVorbisDecode (struct Codec *cod,

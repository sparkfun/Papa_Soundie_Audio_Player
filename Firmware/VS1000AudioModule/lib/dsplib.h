...
__near auto s_int32 DspIir2Lq (register __a0 s_int16 val,
                               register __i0 __near const __mem_y struct
                               DSP_IIR2COEFF16 *baCoeff,
...
auto u_int16 SdCrcBlock (register __i2 u_int16 * block,
                         register __a0 s_int16 words);
auto u_int16 SdCrcBlockChained (register __i2 u_int16 * block,
                                register __a0 u_int16 startCrc,
...
auto u_int32 OggCrcBlockChained (register __i2 u_int16 * block,
                                 register __c0 s_int16 words,
                                 register __reg_a u_int32 startCrc);

...
__near __mem_y void register __i0 *memcpyXY (__near __mem_y void register __i0 * d, __near const void register __i1 * s, size_t register __a0 n);
                                       /**< Copies n words from s to d, where the destination is in Y memory. Returns a pointer to d. */
__near void register __i0 *memcpyYX (__near void register __i0 * d, __near __mem_y const void register __i1 * s, size_t register __a0 n);
                                     /**< Copies n words from s to d, where the source is in Y memory. Returns a pointer to d. */
__near __mem_y void register __i0 *memcpyYY (__near __mem_y void register __i0 * d, __near __mem_y const void register __i1 * s, size_t register __a0 n);
...
__near void memcpyii (__near void register __i0 * d, __near const void register __i1 * s, size_t register __a0 n);
...
__near void memmoveii (__near void register __i0 * d, __near const void register __i1 * s, size_t register __a0 n);
...
void memswapy (register __i0 __mem_y void *a, register __i1 __mem_y void *b, register __a0 size_t size);
                                    /**< Swaps two memory ares, both are in Y memory. The size gives the length of the area. */
void memswapxy (register __i0 void *a, register __i1 __mem_y void *b, register __a0 size_t size);
